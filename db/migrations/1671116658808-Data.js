module.exports = class Data1671116658808 {
    name = 'Data1671116658808'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "totals" ("id" character varying NOT NULL, "finalized_blocks" numeric NOT NULL, "total_issuance" numeric NOT NULL, "signed_extrinsics" numeric NOT NULL, "transfers_count" numeric NOT NULL, "holders" integer NOT NULL, "validators_ideal_count" integer, "validators_count" integer, "staked_value_total" numeric, "staked_value_validator" numeric, "staked_value_nominator" numeric, "nomination_pools_count_members" integer, "nomination_pools_count_pools" integer, "nomination_pools_total_stake" numeric, CONSTRAINT "PK_3480b9650b4eb64138649f2a416" PRIMARY KEY ("id"))`)
