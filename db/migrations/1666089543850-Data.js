module.exports = class Data1666089543850 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "historical_data_meta" ("id" character varying NOT NULL, "holders_latest_block_number" numeric NOT NULL, "holders_latest_time" TIMESTAMP WITH TIME ZONE, "issuance_latest_block_number" numeric NOT NULL, "issuance_latest_time" TIMESTAMP WITH TIME ZONE, "validator_latest_block_number" numeric NOT NULL, "validator_latest_time" TIMESTAMP WITH TIME ZONE, "staking_latest_block_number" numeric NOT NULL, "staking_latest_time" TIMESTAMP WITH TIME ZONE, "transfer_latest_block_number" numeric NOT NULL, "transfer_latest_time" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_5dd7d4f59c6cd7570bf355ef550" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE INDEX "IDX_f4bc42ab76a417b4a69e7a952f" ON "historical_data_meta" ("transfer_latest_block_number") `)
    await db.query(`CREATE INDEX "IDX_333d0f8eef903be3b9a9a230d2" ON "historical_data_meta" ("transfer_latest_time") `)
    await db.query(`CREATE TABLE "holders" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, CONSTRAINT "PK_db78e78aa79aa06fd917151e37f" PRIMARY KEY ("id"))`)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_f4bc42ab76a417b4a69e7a952f"`)
    await db.query(`DROP INDEX "public"."IDX_333d0f8eef903be3b9a9a230d2"`)
