...
export type Event = Event_System | Event_Indices | Event_Sudo | Event_ParachainSystem | Event_Balances | Event_CollatorSelection | Event_Session | Event_Democracy | Event_Council | Event_TechnicalCommittee | Event_PhragmenElection | Event_CouncilMembership | Event_TechnicalMembership | Event_XcmpQueue | Event_PolkadotXcm | Event_CumulusXcm | Event_DmpQueue | Event_Utility | Event_Scheduler | Event_Multisig | Event_Vesting | Event_Treasury | Event_Bounties | Event_Tips | Event_XTokens | Event_Tokens | Event_Currencies | Event_UnknownTokens | Event_FlexibleFee
...
export type FlexibleFeeEvent = FlexibleFeeEvent_FlexibleFeeExchanged | FlexibleFeeEvent_FixedRateFeeExchanged
