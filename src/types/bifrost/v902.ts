...
export type Event = Event_System | Event_Indices | Event_ParachainSystem | Event_Balances | Event_CollatorSelection | Event_Session | Event_Democracy | Event_Council | Event_TechnicalCommittee | Event_PhragmenElection | Event_CouncilMembership | Event_TechnicalMembership | Event_XcmpQueue | Event_PolkadotXcm | Event_CumulusXcm | Event_DmpQueue | Event_Utility | Event_Scheduler | Event_Multisig | Event_Vesting | Event_Treasury | Event_Bounties | Event_Tips | Event_XTokens | Event_Tokens | Event_Currencies | Event_UnknownTokens | Event_OrmlXcm | Event_ZenlinkProtocol | Event_FlexibleFee | Event_Salp | Event_LiquidityMining | Event_TokenIssuer
...
export interface XTokensEvent_Transferred {
  __kind: 'Transferred'
  value: [Uint8Array, CurrencyId, bigint, MultiLocation]
}
...
export interface CurrenciesEvent_Transferred {
  __kind: 'Transferred'
  value: [Currency, Uint8Array, Uint8Array, bigint]
}
...
export interface CurrenciesEvent_BalanceUpdated {
  ...
  value: [Currency, Uint8Array, bigint]
}
...
export interface ZenlinkProtocolEvent_LiquidityAdded {
  ...
  value: [Uint8Array, number, number, bigint, bigint, bigint]
}
...
export interface ZenlinkProtocolEvent_LiquidityRemoved {
  ...
  value: [Uint8Array, Uint8Array, number, number, bigint, bigint, bigint]
}
...
export interface ZenlinkProtocolEvent_TransferredToParachain {
  ...
  value: [number, Uint8Array, number, Uint8Array, bigint, bigint]
}
...
export interface ZenlinkProtocolEvent_BootstrapContribute {
  ...
  value: [Uint8Array, number, bigint, number, bigint]
}
...
export interface ZenlinkProtocolEvent_BootstrapEnd {
  __kind: 'BootstrapEnd'
  value: [number, number, bigint, bigint, bigint]
}
...
export interface ZenlinkProtocolEvent_BootstrapCreated {
  ...
  value: [Uint8Array, number, number, bigint, bigint, bigint, bigint, number]
}
...
export interface ZenlinkProtocolEvent_BootstrapClaim {
  ...
  value: [Uint8Array, Uint8Array, Uint8Array, number, number, bigint, bigint, bigint]
}
...
export interface ZenlinkProtocolEvent_BootstrapRefund {
  ...
  value: [Uint8Array, Uint8Array, number, number, bigint, bigint]
}
...
export interface FlexibleFeeEvent_ExtraFeeDeducted {
  ...
  value: [ExtraFeeName, CurrencyIdOf, bigint]
}
