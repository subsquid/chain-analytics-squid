...
export type SalpEvent = SalpEvent_Created | SalpEvent_Contributing | SalpEvent_Contributed | SalpEvent_ContributeFailed | SalpEvent_Withdrew | SalpEvent_Refunded | SalpEvent_Redeemed | SalpEvent_Edited | SalpEvent_Dissolved | SalpEvent_Unlocked | SalpEvent_AllUnlocked | SalpEvent_Failed | SalpEvent_Success | SalpEvent_Retired | SalpEvent_End | SalpEvent_ProxyAdded | SalpEvent_ProxyRemoved | SalpEvent_Minted
